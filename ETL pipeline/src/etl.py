...
def transform_toCube():
    ...
    print("Paso2 - CREAR DIMENSION DE TIEMPO")
    ...
    print("Paso3 - CREAR DIMENSION DE DIVISA CON LOS TIPOS DE MONEDAS")
    ...
    print("Paso4 - CREAR DIMENSION CON LOS GATEWAY")
    ...
    print("Paso5 - CREAR DIMENSION TIPO DE PAGO")
    ...
    print("Paso6 - CREAR FACT TABLE DE PAGOS")
    ...
    print("Paso7 - CREAR FACT TABLE DE CHARGEBACKS")
...
def load_Cube():
    ...
    print("Paso1 - CARGA DATOS EN DIMENSION DE TIEMPO")
    ...
    print("Paso2 - CARGA DATOS EN DIMENSION DE DIVISA CON LOS TIPOS DE MONEDAS")
    ...
    print("Paso3 - CARGA DATOS EN DIMENSION CON LOS GATEWAY")
    ...
    print("Paso4 - CARGA DATOS EN DIMENSION TIPO DE PAGO")
    ...
    print("Paso5 - CARGA DATOS EN FACT TABLE DE PAGOS")
    ...
    print("Paso6 - CARGA DATOS EN FACT TABLE DE CHARGEBACKS")
