...
def transform_toCube():
    ...
    conn = cur.connect()
    print("Paso1/7 - tranforma los valores 0 que tiene la tabla en un valor default")
    cur.execute("update stg_chargebacks set debit_date = 19000101 where debit_date = 0;")

    # CREAR DIMENSION DE TIEMPO
    print("Paso2/7 - CREAR DIMENSION DE TIEMPO")
    ...
    print("Paso3/7 - CREAR DIMENSION DE DIVISA CON LOS TIPOS DE MONEDAS")
    ...
    print("Paso4/7 - CREAR DIMENSION CON LOS GATEWAY")
    ...
    print("Paso5/7 - CREAR DIMENSION TIPO DE PAGO")
    ...
    print("Paso6/7 - CREAR FACT TABLE DE PAGOS")
    ...
    print("Paso7/7 - CREAR FACT TABLE DE CHARGEBACKS")
...
def load_Cube():
    ...
    print("Paso1/6 - CARGA DATOS EN DIMENSION DE TIEMPO")
    ...
    print("Paso2/6 - CARGA DATOS EN DIMENSION DE DIVISA CON LOS TIPOS DE MONEDAS")
    ...
    print("Paso3/6 - CARGA DATOS EN DIMENSION CON LOS GATEWAY")
    ...
    print("Paso4/6 - CARGA DATOS EN DIMENSION TIPO DE PAGO")
    ...
    print("Paso5/6 - CARGA DATOS EN FACT TABLE DE PAGOS")
    ...
    print("Paso6/6 - CARGA DATOS EN FACT TABLE DE CHARGEBACKS")
