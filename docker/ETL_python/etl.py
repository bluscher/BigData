...
dir = r'/bigdata'
dir_payments = r'./data/payments'
dir_charges = r'./data/chargebacks'
#---
a_eliminar = []
flag_dbStaging = 0
...
try: 
    ...
    t_endE = time.time()
    print(">>El tiempo total del extract es: ", end=" ")
    print("  ",t_endE - t_startE, "Segundos")
    print("")
    ...
    if flag_dbStaging == 1:
     ...
     t_endT = time.time()
     print(">>El tiempo total de ejecucion de la transformacion es: ", end=" ")
     print("  ",t_endT - t_startT, "Segundos")
     print("")
     t_startL = time.time()
     print ("[L]OAD DATA ")
     load_Cube()
     print ("[end] - LOAD DATA ")
     t_endL = time.time()
     print(">>El tiempo total de ejecucion de la carga es: ", end=" ")
     print("  ",t_endL - t_startL, "Segundos")
     t_end = time.time()
